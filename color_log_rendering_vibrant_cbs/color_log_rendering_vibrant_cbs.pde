import java.awt.Color; // import Color class for saturation operations
...
float gamma = 1.0; // alpha gamma
float cgamma = 1.5; // color gamma
float color_mix = 0.5; // mix between color averaged and gamma corrected
float brightness = 1.2; // brightness factor
float contrast = 1.2; // contrast factor
float saturation = 2.0; // saturation factor
